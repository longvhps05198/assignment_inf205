...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-12" style="width: 96%; padding:0; margin-left: 2%; margin-right: 2%;">
                ...
                <table class="table">
                  ...
                  <tr>
                    <td>
                      ...
                      <a href="" style="color: #0E4EB5">Sản phẩm</a>
                    </td>
                  </tr>
                  <tr>
                    <td>
      ...
      <div class="col-md-9" style="padding:0; width: 80%;margin-bottom: 20px;">
        ...
        <div class="col-md-12" style="width: 100%;border: 1px solid #e3e3e3;padding: 20px 10px">
          <%
              Sanpham sp = new Sanpham();
              Sanpham[] list = sp.getConnectSP("select * from SANPHAM join CHITIETSP on SANPHAM.ID = CHITIETSP.ID where left(SANPHAM.ID,4) like '%SPNU%'");
          %>
                ...
                <tbody>
                  ...
                  <form action="Controller_Manage">
                    ...
                    <tr>
                      ...
                      <td align="center">${rows.giaGoc}</td>
                      <td align="center">${rows.giaKhuyenMai}</td>
                      <td align="center">${rows.chietKhau}</td>
                      ...
                      <td align="center"><a href='${del}' onclick="return confirm('Bạn có chắc muốn xóa?')" class='glyphicon glyphicon-remove' style='border: 1px solid #f07b1d; padding: 5px'></a>
                        <c:url var="up" value="Controller_Manage">
                            <c:param name="btnAction" value="Show_update" />
                            <c:param name="ID" value="${rows.id}" />
                            <c:param name="sex" value="women" />
                        </c:url>
...
<script>
    $(document).ready(function () {
        $('#example').DataTable();
        $('.sorting:eq(0)').css("width", "25%");
        $('.sorting:eq(2)').css("width", "10%");
        $('.sorting:eq(3)').css("width", "8%");
        $('.sorting:eq(4)').css("width", "25%");
        $('.sorting:eq(4)').css("text-align", "center");
        $('.sorting:eq(5)').css("text-align", "center");
    });
</script>
