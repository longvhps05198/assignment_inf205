                  ...
                  <form action="Controller_Manage">
                    ...
                    <div class="col-md-6" style="width: 60%">
                      ...
                      <div class="row" style="margin:10px 10px 10px 0">
                        ...
                        <input type="text" name="txtTensanpham" value="${rows.tenSanPham}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Giá gốc</div>
                        <input type="text" name="txtGiagoc" value="${rows.giaGoc}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Giá khuyến mãi</div>
                        <input type="text" name="txtGiakhuyenmai" value="${rows.giaKhuyenMai}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Chiết khấu</div>
                        <input type="text" name="txtChietkhau" value="${rows.chietKhau}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Hình ảnh</div>
                        <input type="text" id="urlimg" name="txtImage" value="${rows.image}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Phân loại</div>
                        <%--<input type="text" name="txtPhanloai" value="${rows.phanLoai}" style="width: 74%">--%>
                      ...
                      <script>
                          $('.choice-product').val("${rows.phanLoai}");
                      </script>   
                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Mô tả</div>
                        <textarea rows="5" name="txtMota" style="width: 74%">${rows.moTa}</textarea>
                        <%--<input type="text" value="${rows.moTa}" style="width: 60%">--%>
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Kiểu dáng</div>
                        <input type="text" name="txtKieudang" value="${rows.kieuDang}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Màu sắc</div>
                        <input type="text" name="txtMausac" value="${rows.mauSac}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Chất liệu</div>
                        <input type="text" name="txtChatlieu" value="${rows.chatLieu}" style="width: 74%">
                      </div>

                      <div class="row" style="margin:10px 10px 10px 0">
                        <div class="label-up">Xuất xứ</div>
                        <input type="text" name="txtXuatxu" value="${rows.xuatXu}" style="width: 74%">
                      </div>
                    ...
                    <div class="col-md-5" style="width: 40%;margin-top: 10px">
                      <div style="border: 1px solid #333"><img id="show-img" src="${rows.image}" width="100%"></div>
                      <input type="file" id="imgInp" name="Upload" value="" style="margin-top: 14px;">
                    </div>
                  </form>
                </div>
            </c:forEach>
