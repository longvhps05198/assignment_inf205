    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12" style="margin-left: 5%; width: 90%; margin-top: 20px;">
          <p><a href="index.jsp" style="color: #333">Trang chủ</a> &raquo; <a href="san-pham-nam.jsp?trang=1" style="color: #75BF97">Thời trang nam</a></p>
          <div class="tabcontent">
            <h1 class="title clearfix"><span>THỜI TRANG NAM</span></h1>
            <ul class="tab-cates" style="list-style-type: none ">
              <li><a href="sp-ao-nam.jsp?trang=1">Áo nam</a></li>
              <li><a href="sp-quan-nam.jsp?trang=1">Quần nam</a></li>
            </ul>
          </div>
          ...
          <div class="row">
            <div class="col-md-12" style="margin: 10px 0">
              <div class="row">
                ...
                %>
                <%
                    String sql = "select * from SANPHAM join CHITIETSP on SANPHAM.ID = CHITIETSP.ID "
                    ...
                    sql += " ORDER BY SANPHAM.ID OFFSET " + viTri + " ROWS FETCH NEXT " + soDongTrang + " ROWS ONLY;";
                    rs = stm.executeQuery(sql);
                %>
                <%
                    int stt = 1;
                  ...
                  <div class="eitem thumbnail">
                    ...
                    <div class="add-to-cart">
                      <c:url var="add" value="Controller_Manage">
                          ...
                          <c:param name="gioitinh" value="nam" />
                      </c:url>
              ...
              <div class="row" style="margin: 20px 0">
                <div class="store-pagination clear"> 
                  <a class="page-numbers" href="san-pham-nam.jsp?trang=1">&laquo;</a>
                  <a class="page-numbers" href="san-pham-nam.jsp?trang=<%=(trang - 1) < 1 ? 1 : trang - 1%>">&lsaquo;</a>
                  <%for (int i = 1; i <= soTrang; i++) {
                        if (i == trang) {%>
                  <span class="page-numbers current"><%=trang%></span>
                  <%} else {%>
                  <a class="page-numbers" href="san-pham-nam.jsp?trang=<%=i%>"><%=i%></a>
                  <%}
                    }%>
                  <a class="page-numbers" href="san-pham-nam.jsp?trang=<%=(trang + 1 > soTrang) ? soTrang : trang + 1%>">&rsaquo;</a>
                  <a class="page-numbers" href="san-pham-nam.jsp?trang=<%=soTrang%>">&raquo;</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <%
          session.setAttribute("currentpage", "san-pham-nam.jsp");
      %>
