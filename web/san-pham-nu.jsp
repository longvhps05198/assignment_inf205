...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12" style="margin-left: 5%; width: 90%; margin-top: 20px;">
          <p><a href="index.jsp" style="color: #333">Trang chủ</a> &raquo; <a href="san-pham-nu.jsp?trang=1" style="color: #75BF97">Thời trang nữ</a></p>
            ...
            <div class="col-md-12" style="margin: 10px 0">
              ...
              <div class="row" style="margin: 20px 0">
                <div class="store-pagination clear"> 
                  <a class="page-numbers" href="san-pham-nu.jsp?trang=1">&laquo;</a>
                  <a class="page-numbers" href="san-pham-nu.jsp?trang=<%=(trang - 1) < 1 ? 1 : trang - 1%>">&lsaquo;</a>
                  <%for (int i = 1; i <= soTrang; i++) {
                          if (i == trang) {%>
                  <span class="page-numbers current"><%=trang%></span>
                  <%} else {%>
                  <a class="page-numbers" href="san-pham-nu.jsp?trang=<%=i%>"><%=i%></a>
                  <%}
                      }%>
                  <a class="page-numbers" href="san-pham-nu.jsp?trang=<%=(trang + 1 > soTrang) ? soTrang : trang + 1%>">&rsaquo;</a>
                  <a class="page-numbers" href="san-pham-nu.jsp?trang=<%=soTrang%>">&raquo;</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <%
        session.setAttribute("currentpage", "san-pham-nu.jsp");
    %>
