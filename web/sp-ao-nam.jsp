...
<html lang="en">
  ...
  <body>
    <div class="container">
          ...
          <div class="row">
            <div class="col-md-12" style="margin: 10px 0">
              <div class="row">
                ...
                %>
                <%
                    String sql = "select * from SANPHAM where Phanloai=N'Áo nam'";
              ...
              <div class="row" style="margin: 20px 0">
                <div class="store-pagination clear"> 
                  <a class="page-numbers" href="sp-ao-nam.jsp?trang=1">&laquo;</a>
                  <a class="page-numbers" href="sp-ao-nam.jsp?trang=<%=(trang - 1) < 1 ? 1 : trang - 1%>">&lsaquo;</a>
                  <%for (int i = 1; i <= soTrang; i++) {
                        if (i == trang) {%>
                  <span class="page-numbers current"><%=trang%></span>
                  <%} else {%>
                  <a class="page-numbers" href="sp-ao-nam.jsp?trang=<%=i%>"><%=i%></a>
                  <%}
                    }%>
                  <a class="page-numbers" href="sp-ao-nam.jsp?trang=<%=(trang + 1 > soTrang) ? soTrang : trang + 1%>">&rsaquo;</a>
                  <a class="page-numbers" href="sp-ao-nam.jsp?trang=<%=soTrang%>">&raquo;</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <%
          session.setAttribute("currentpage", "sp-ao-nam.jsp");
      %>
